...
public class App {
    ...
    public static void main(String[] args) {
        ...
        boolean isExist = decision(divisior);
            System.out.println("A sorozatban  "+(isExist ?  "van " : "nincs ")+ divisior +"-al soztható szám.");
            if (isExist) {
                System.out.println("A sorozat " + (selectiom(divisior) + 1 ) + ". eleme osztható " + divisior + "-val.");
            }
    }
    ...
    private static int selectiom(int divisor) {
        int i = 0;
